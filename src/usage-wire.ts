...
export const USAGE_HOST_CONTRIBUTION = {
  ...
  // Remote deliberately has no generated reflection exports, so use the
  // official empty-model form rather than a cast that would leave registry
  // inspection with `model: undefined`.
