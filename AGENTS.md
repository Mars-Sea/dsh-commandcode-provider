...
- **Wire protocol** (reverse-engineered, command-code@1.28.4):
  ...
  - Defaults: `apiBase = https://api.commandcode.ai`, `COMMAND_CODE_CLI_VERSION = '1.28.4'`.
