	...
	factory: (require) => {
		...
		*/
		...
		const SECTION_FIELDS = [
			...
			numberField$1("commandGuardThreshold", {
				min: .5,
				max: 1
			}),
			numberField$1("commandGuardTimeoutMs", {
				min: 200,
				max: 1e4
			}),
			booleanField$1("zdr"),
					...
					expanded ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Field, {
								...
								disabled,
								onEdit: (text) => onEdit("commandGuardThreshold", text),
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Field, {
								...
								disabled,
								numeric: true,
								onEdit: (text) => onEdit("commandGuardTimeoutMs", text),
		...
		function AccountsCard({ t, state, login, disabled, onAdd, onRemove, onLabel, onKey, onToggleClear, onActive, onActiveReset, onBeginLogin, onCancelLogin }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					state.accounts.map((account) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "cc-accountEditor",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(AccountRow, {
							account,
						...
						}), account.added ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: "cc-accountLoginHint",
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								className: "cc-hint",
								children: t("accountLoginAfterSave")
							})
						}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LoginRow, {
							state: login,
							targetRef: account.ref,
							disabled: disabled || !account.writable || state.dirty,
							disabledHint: state.dirty ? t("loginSaveBefore") : void 0,
							t,
		...
		*/
		...
		function CommandCodeSettingsPage(props) {
			const { t } = props;
			const footerMarker = (0, react.useRef)(null);
			const [footerFloating, setFooterFloating] = (0, react.useState)(false);
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SecretKeyField, {
							...
							state: state.apiKey,
							disabled: disabled || keyLocked || login.targetRef === void 0 && (login.phase === "starting" || login.phase === "waiting"),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						ref: footerMarker,
						className: "cc-footerMarker",
						"aria-hidden": "true"
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: `cc-footer cc-footerSticky${footerFloating ? " cc-footerFloating" : ""}`,
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: "cc-footerActions",
							children: [
...
`;
		...
		const zh = {
			...
			zdr: "零数据保留（ZDR）",
			zdrHint: "开启后，请求只经由不留存提示词与回复、也不用于训练的上游（等价于 CLI 的 CMD_ZDR=1）。没有可用 ZDR 上游的模型会返回错误，请换用其他模型或关闭此开关。ZDR 容量按上游实价透传，通常更贵；费用读数仍按常规目录价估算。默认关闭。",
			accountsTitle: "多账户轮换",
		...
		const en = {
			...
			commandGuardHint: "Before a shell command asks for approval, typesafe/jev judges whether it is safe: safe commands run without a prompt, everything else asks as usual. Off by default.",
			commandGuardThreshold: "Auto-approve threshold (0.5–1)",
			commandGuardThresholdHint: "Approve when typesafe/jev rates the command \"safe\" at least this likely; default 0.9.",
			commandGuardTimeoutMs: "Judgement timeout (ms, 200–10000)",
			commandGuardTimeoutMsHint: "If typesafe/jev does not answer in time, the normal prompt appears; default 1500.",
			zdr: "Zero data retention (ZDR)",
			zdrHint: "Serve requests only through upstreams that keep no prompts or completions and never train on them (the same opt-in as the CLI's CMD_ZDR=1). A few models have no ZDR upstream; requests for those models fail rather than losing ZDR protection. ZDR capacity is billed at the upstream's pass-through rates and usually costs more; the cost readout keeps quoting the ordinary catalog rates. Off by default.",
